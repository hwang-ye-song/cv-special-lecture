...
<img src="./images/progressive-disclosure.png" alt="Progressive Disclosure" width="640">
...
<img src="./images/skills-composable.png" alt="Skills 조합 예시" width="640">

#### 세팅 방법

프로젝트 안에 skills 폴더를 만들고 그 안에 skill 폴더를 넣음 (Codex는 `.codex/skills/`, Claude Code는 `.claude/skills/`)
